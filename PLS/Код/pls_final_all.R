# ============================================================
# END-TO-END: cSEM two-stage (2nd order) + bootstrap
# OUTPUT to Excel: direct paths + indirect effects + R2
# Data source: all_cfa_sem.xlsx (explicit), columns list explicit
# ============================================================
...
# 5) EXPORT
# -------------------------
out_file <- "all_pls_2stage_direct_indirect_r2.xlsx"
